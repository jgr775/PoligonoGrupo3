...
public class PoligonoController {
	...
	@FXML
	private Button addpoitnButton;
	@FXML
	private Canvas poligonoCanvas;
	@FXML
	private TextField xInput;
	@FXML
	private TextField yInput;
	@FXML
	private Text concavoInput;
	@FXML
	private Text centroideInput;

	@FXML
	private TextField c1x1;
	@FXML
	private TextField c1x2;
	@FXML
	private TextField c1y1;
	@FXML
	private TextField c1y2;

	@FXML
	private TextField c2Pendiente;
	@FXML
	private TextField c2Origen;

	@FXML
	private TextField c3Pendiente;
	@FXML
	private TextField c3x;
	@FXML
	private TextField c3y;

	@FXML
	private TextField c4a;
	@FXML
	private TextField c4b;
	@FXML
	private TextField c4c;

	@FXML
	private TextField c5Abcisa;
	@FXML
	private TextField c5Ordenada;
	...
	@FXML
	private Button btnr1c4;
	@FXML
	private Button btnr2c4;
	@FXML
	private Button btnr1c5;
	@FXML
	private Button btnr2c5;
	...
	private void drawTriangulos(Triangulo[] triangulos) {
		...
		for (Triangulo t : triangulos) {
			...
			gc.strokeLine(triangulo[0].getX() * 50 + 320, triangulo[0].getY() * 50 + 235,
					triangulo[1].getX() * 50 + 320, triangulo[1].getY() * 50 + 235);
			gc.strokeLine(triangulo[1].getX() * 50 + 320, triangulo[1].getY() * 50 + 235,
					triangulo[2].getX() * 50 + 320, triangulo[2].getY() * 50 + 235);
			gc.strokeLine(triangulo[2].getX() * 50 + 320, triangulo[2].getY() * 50 + 235,
					triangulo[0].getX() * 50 + 320, triangulo[0].getY() * 50 + 235);
		}
		gc.setStroke(Color.BLACK);
	}
		...
		public void handle(ActionEvent evt) {
			try {
				if (evt.getSource().equals(btnr1c1) || evt.getSource().equals(btnr2c1)) {
					...
					double x, y;
					boolean eje = false;
					if (c5Abcisa.getText().equals("") && c5Ordenada.getText().equals(""))
						return;
					if (c5Abcisa.getText().equals("")) {
						x = 0;
					} else
						x = Double.parseDouble(c5Abcisa.getText());
					if (c5Ordenada.getText().equals("")) {
						y = 0;
					} else
						y = Double.parseDouble(c5Ordenada.getText());
					if (x == 0)
						eje = true;
					Punto p = new Punto(x, y);
					c5Abcisa.setText("");
		...
		private void intersectan() {
			if (linea1 != null && linea2 != null) {
				if (Recta.sonParalelas(linea1, linea2))
					...
					pCorte.setText("Se cortan en " + Recta.puntoCorte(linea1, linea2).toString());
			}
