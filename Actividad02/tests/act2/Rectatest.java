...
public class Rectatest {
	...
	public void setUp() throws Exception {
		...
		normal4 = new Recta(cuatro,true);
		normal5 = new Recta(cinco,false);
		normal6 = new Recta(seis,true);
		normal7 = new Recta(siete,false);
